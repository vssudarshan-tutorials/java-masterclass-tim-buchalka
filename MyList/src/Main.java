public class Main {
    ...
    public static void main(String[] args) {
        ...
        MyAbstractItem nameItem1 = new NameItem("Sud");
        MyAbstractItem nameItem2 = new NameItem("Sul");
        MyAbstractItem nameItem3 = new NameItem("Sam");
        MyAbstractItem nameItem4 = new NameItem("Asha");
        MyAbstractItem nameItem5 = new NameItem("Pops");

//        IntegerItem p = new IntegerItem(1);
//
//        nameList.add(p);
